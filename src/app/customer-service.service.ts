...
export class CustomerServiceService {
  private url = "http://20.121.156.211:8081/dari/client"
  httpOptions = {
  ...
  updateCustomerblock(cust: any,id:number): Observable<any[]> {
    return this.httpClient.put<any[]>(this.url + "/updateblock/"+id, JSON.stringify(cust), this.httpOptions).pipe(catchError(this.handleError))
  }
