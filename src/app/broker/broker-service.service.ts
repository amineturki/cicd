...
export class BrokerServiceService {
  private url="http://20.121.156.211:8081/dari/agent"
  httpOptions={
  ...
  updateBrokerblock(broker:any,id:number):Observable<any[]>{
    return this.httpClient.put<any[]>(this.url+"/updateblock/"+id,JSON.stringify(broker),this.httpOptions).pipe(catchError(this.handleError))
  }
